...
import com.lionelyarboi.kickstarter.config.MobilePropertiesContext;
...
public class MobileCapabilities {
    ...
    private void setCapabilities() {
        if (platform.equals("ios")) {
            ...
            capabilities.setCapability(MobileCapabilityType.APP, path.toFile().getAbsolutePath().concat("/apps/KickDebug.app"));
            ...
            capabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, version);
            capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, name);
            capabilities.setCapability(MobileCapabilityType.APP, path.toFile().getAbsolutePath().concat("/apps/base.apk"));
